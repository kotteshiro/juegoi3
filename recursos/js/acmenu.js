function acmenu(conten,btns){
	...
	btn("inst79" ,ac,{sprite:[spicnsoc, 0, 0+la], x: 4, y:posy+(sep*0)+padtop, click:scprinc.fnclick,soundhover:"CONTROLES"}).setScale(1,1);
	btn("inst80" ,ac,{sprite:[spicnsoc, 1, 1+la], x: 4, y:posy+(sep*1)+padtop, click:scprinc.fnclick,soundhover:"CONTROLES"}).setScale(1,1);
	btn("inst81" ,ac,{sprite:[spicnsoc, 2, 2+la], x: 4, y:posy+(sep*2)+padtop, click:scprinc.fnclick,soundhover:"CONTROLES"}).setScale(1,1);
	btn("inst82" ,ac,{sprite:[spicnsoc, 3, 3+la], x: 4, y:posy+(sep*3)+padtop, click:scprinc.fnclick,soundhover:"CONTROLES"}).setScale(1,1);
...
function acmenupric(conten,btns){
	...
	var btn1=btn("btn"+btns[0].ix,ac,{sprite:[spiconos, btns[0].ix, btns[0].ix+sp], x: -10-xdif, y: 65*0, click:btns[0].fn,soundhover:"CONTROLES"}).setScale(1,1);
	var btn4=btn("btn"+btns[1].ix ,ac,{sprite:[spiconos, btns[1].ix, btns[1].ix+sp], x: -10-xdif, y: 65*1, click:btns[1].fn,soundhover:"CONTROLES"}).setScale(1,1);
	updatebtnmute(btn4);
	conten.botonmute=btn4;
	/*btn("inst16" ,ac,{sprite:[spiconos, 6, 6+sp], x: -10, y:333+40-110, click:scprinc.fnclick}).setScale(.5,.5);
	btn("inst17" ,ac,{sprite:[spiconos, 6, 6+sp], x: -10, y:377+40-110, click:scprinc.fnclick}).setScale(.5,.5);
